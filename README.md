...
```sh
git add .\index.html
git commit -m "First git init description commit"
```
**Задание 4**. Дополните файл style.css. Индексируйте измененные файлы и выполните коммит.
```sh
git add style.css
git commit -m "style.css changes commit"
```
...
```sh
git push https://github.com/Hdjfhbfhfjfjfjfjjdjjrvtjfi/profession_lab_5
```
